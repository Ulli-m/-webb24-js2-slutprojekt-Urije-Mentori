...
export function App() {
  ...
  function onAddToCart(selectedProduct) {
    ...
    // Uppdaterar lagret på servern om produkten fortfarande finns
    if (selectedProduct.stock > 0) {
      const updatedStock = { stock: selectedProduct.stock - 1 };
      patchProduct(selectedProduct.id, updatedStock);
    }
  }
